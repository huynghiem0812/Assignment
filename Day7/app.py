...
@app.route('/products')
def get_products():
    product_list = pd.read_csv('D:/VS Code/Assignment/Day7/products.csv')
...
def add_new_product():
    if request.method == 'GET':
        ...
        products = pd.read_csv('D:/VS Code/Assignment/Day7/products.csv')
        ...
        df.to_csv('D:/VS Code/Assignment/Day7/products.csv')
